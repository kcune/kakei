<?php
    ...
    if ($_SESSION['from'] == 'Shop_month_total_phone'){
    ...
    if (empty($_SESSION['error'])){
        ...
        try{
            ...
            }elseif($_SESSION['from']=='Shop_month_total_phone'){
            ...
            //月毎のクロス集計を作る
            $rec_cross = $db->selectShopCrossMonthTotalPhone($_SESSION['year'],$_SESSION['month']);

            //画面遷移用
            $_SESSION['from'] = 'Shop_month_total_phone';
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-success">
        <div class="navmoji">
            <span class="navbar-brand">店別月間集計表</span>
        </div>
    </nav>
    <!-- ナビゲーション ここまで --> 
