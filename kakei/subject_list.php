...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-success">
        <div class="navmoji">
            <span class="navbar-brand">勘定科目</span>
        </div>
    </nav>
    <!-- ナビゲーション ここまで --> 
    ...
    <div class="container">
        ...
        <div class="row my-2">
            ...
            <div class="col-sm-5">
                    ...
                    <tbody>
                        <?php foreach($rec as $val): ?>
                            <tr>
                                ...
                                <!-- 計算 -->
                                <td><?php if($val['calc_flg']==0){echo '計算する';}else{echo '計算しない';} ?></td>
                                <!-- 修正ボタン -->
                                <td style="width: 40px;">
                                    <form method="post" action="./subject_update.php">
                                        <input type="hidden" name="token" value="<?php echo $token; ?>">
                                        <input type="hidden" name="id" value="<?php echo $val['id'] ?>">
                                        <input type="hidden" name="account" value="<?php echo $val['account'] ?>">
                                        <input type="hidden" name="calc_flg" value="<?php echo $val['calc_flg'] ?>">
                                        <input type="submit" value="修正" class="btn btn-success">
                                    </form>
                                </td>
                                <!-- 削除ボタン -->
                                <td style="width: 40px;">
                                    <form method="post" action="./subject_delete_action.php">
                                        <input type="hidden" name="token" value="<?php echo $token; ?>">
                                        <input type="hidden" name="id" value="<?php echo $val['id'] ?>">
                ...
                <!-- ボタン -->
                <a href="./subject_add.php" class="btn btn-success">追加</a>
            </div>
            <div class="col-sm-3"></div>
        </div>
        <!-- 入力フォーム ここまで -->
