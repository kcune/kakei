...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-success">
        <div class="navmoji">
            <span class="navbar-brand">入出金追加</span>
        </div>
    </nav>
    <!-- ナビゲーション ここまで --> 
    ...
    <div class="container" style="width: 800px;">
        ...
        <div class="row">
            <div class="col-sm-3"></div>
            <div class="col-sm-6">
                <form action="./record_add_action.php" method="post">
                    <input type="hidden" name="token" value="<?php echo $token; ?>">
                    <input type="hidden" name="medium" value="<?php echo $_SESSION['medium_id'] ?>">
                    <!-- 日付 -->
                    ...
                    <!-- 貸方 -->
                    <div class="form-group mb-4 formgroup">
