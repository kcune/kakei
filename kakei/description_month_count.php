<?php
    ...
    if ($_SESSION['from'] == 'Description_month_count'){
    ...
    if (empty($_SESSION['error'])){
        ...
        try{
            ...
            }elseif($_SESSION['from']=='Description_month_count'){
            ...
            //月毎のクロス集計を作る
            $rec_cross = $db->selectDescriptionCrossMonthCount($_SESSION['year']);

            //画面遷移用
            $_SESSION['from'] = 'Description_month_count';
