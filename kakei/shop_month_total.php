<?php
    ...
    if ($_SESSION['from'] == 'Shop_month_total'){
    ...
    if (empty($_SESSION['error'])){
        ...
        try{
            ...
            }elseif($_SESSION['from']=='Shop_month_total'){
            ...
            //月毎のクロス集計を作る
            $rec_cross = $db->selectShopCrossMonthTotal($_SESSION['year']);

            //画面遷移用
            $_SESSION['from'] = 'Shop_month_total';
