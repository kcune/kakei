...
if (isset($_SESSION['error'])) {
    ...
    //アカウント作成画面に移動
    header('Location:./record_update.php');
    exit;
}
...
try {
    ...
    //アカウント情報を追加する
    $db->updateMoney($_SESSION['user_id'],$_POST['medium_id'],$_POST['id'],$_POST['spent_date'],$_POST['account'],$_POST['description'],$_POST['shop'],$_POST['debit'],$_POST['credit']);
