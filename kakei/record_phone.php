    ...
    <div class="container">
        ...
        <div class="row my-2">
            ...
            <div class="col-sm-5">
                ...
                <a href="./menu_phone.php" class="btn btn-success">戻る</a><br>
                <!-- 口座 -->
                ...
                <table class="table table-striped table-hover mt-1">
                    ...
                    <tbody>
                        <?php foreach($rec_money as $val): ?>
                            <tr>
                                <!-- 日付 -->
                                <td width="50" height="20"><?php echo substr($val['spent_date'],8,2); ?></td>
                                <!-- 摘要 -->
                                <td width="300"><?php echo $val['description']; ?></td>
                                <!-- 貸方 -->
                                ...
                                <td width="20">
                                    <form method="post" action="./record_update.php">
                                        ...
                                        <input type="submit" value="修正" class="btn btn-success btn_set mr-0">
                                    </form>
                                </td>
                                <!-- 削除ボタン -->
                                <td width="20">
