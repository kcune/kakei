<?php
    ...
    if (empty($_SESSION['error'])){
        ...
        try{
            ...
            }elseif($_SESSION['from']=='DayCount_phone'){
            ...
            $rec_cross = $db->selectCreditCrossPhone($_SESSION['year'],$_SESSION['month']);

            //画面遷移用
            $_SESSION['from'] = 'DayCount_phone';
                ...
                <table class="table table-striped table-hover mt-1">
                    ...
                    <tbody>
                        <?php foreach($rec_cross as $val): ?>
                            <tr>
                                <!-- 日付 -->
                                <td width="50"><?php echo $val['date']; ?></td>
                                <!-- 科目 -->
