<?php
    ...
    if ($_SESSION['from'] == 'Description_month_count_phone'){
    ...
    if (empty($_SESSION['error'])){
        ...
        try{
            ...
            }elseif($_SESSION['from']=='Description_month_count_phone'){
            ...
            //月毎のクロス集計を作る
            $rec_cross = $db->selectDescriptionCrossMonthCountPhone($_SESSION['year'],$_SESSION['month']);

            //画面遷移用
            $_SESSION['from'] = 'Description_month_count_phone';
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-success">
        <div class="navmoji">
            <span class="navbar-brand">摘要別月間頻度表</span>
        </div>
    </nav>
    <!-- ナビゲーション ここまで --> 
