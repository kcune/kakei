<?php
    ...
    require_once('../db/DescriptionCount.php');
    ...
    if ($_SESSION['from'] == 'Description_month_total_phone'){
    ...
    if (empty($_SESSION['error'])){
        ...
        try{
            ...
            }elseif($_SESSION['from']=='Description_month_total_phone'){
            ...
            //月毎のクロス集計を作る
            $rec_cross = $db->selectDescriptionCrossMonthTotalPhone($_SESSION['year'],$_SESSION['month']);

            //画面遷移用
            $_SESSION['from'] = 'Description_month_total_phone';
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-success">
        <div class="navmoji">
            <span class="navbar-brand">摘要別月間集計表</span>
        </div>
    </nav>
    <!-- ナビゲーション ここまで --> 
