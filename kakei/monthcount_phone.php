<?php
    ...
    require_once('../db/MonthCount.php');
    ...
    if ($_SESSION['from'] == 'MonthCount_phone'){
    ...
    if (empty($_SESSION['error'])){
        ...
        try{
            ...
            $rec_cross = $db->selectCreditCrossMonthPhone($_SESSION['year'],$_SESSION['month']);

            //画面遷移用
            $_SESSION['from'] = 'MonthCount_phone';
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-dark bg-success">
        <div class="navmoji">
            <span class="navbar-brand">月間集計表</span>
        </div>
    </nav>
    <!-- ナビゲーション ここまで --> 
